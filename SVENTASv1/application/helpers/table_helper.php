<?php
/*
Trae la tabla HTML para gestionar personas
*/
...
/*
Trae las filas de datos HTML de las personas.
*/
...
function get_person_data_row($person,$controller)
{
	...
	$table_data_row.='<td width="20%">'.character_limiter($person->documento,13).'</td>';
...
/*
Trae la tabla HTML para gestionar a los proveedores .
*/
...
/*
Trae las filas de datos HTML para el proveedor.
*/
...
function get_supplier_data_row($supplier,$controller)
{
	...
	$table_data_row.='<td width="17%">'.character_limiter($supplier->documento,13).'</td>';
...
/*
Trae la tabla HTML para gestionar los articulos.
*/
...
/*
Trae las filas de datos HTML de los productos.
*/
