...
{
	/*
	Determina si el item_id dado es un elemento
	*/
	...
	*/
	...
	/*
	 información sobre un articulo en particular
	*/
	function get_info($item_id)
	{
		...
		{
			//dar vacío objeto , si $ item_id no es un elemento
			$item_obj=new stdClass();

			//traer todos los campos de la tabla de artículos
	...
	/*
	traer un ID de elemento dado un número de orden
	*/
	...
	/*
	traer la información acerca de varios elementos
	*/
	...
	*/
	function delete_list($item_ids)
	{
 	...
 	/*
	sugerencias de búsqueda para encontrar artículos
	*/
	function get_search_suggestions($search,$limit=25)
	{
		...
		//devolver sólo sugerencias límite
