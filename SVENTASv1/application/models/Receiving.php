...
class Receiving extends CI_Model
{
	...
	//Creamos una tabla temporal que nos permite hacer fáciles de informes / consultas
	public function create_receivings_items_temp_table()
	{
		...
		".$this->db->dbprefix('receivings_items').".line as line, ".$this->db->dbprefix('receivings_items').".description as description,
