...
<head>
	...
	<link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/sv.css" />
	<link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/sv_print.css"  media="print"/>
	...
	<div id="menubar_container">
		...
		<div id="menubar_navigation">
			...
			<div class="menu_item" >
				...
				<img src="<?php echo base_url().'images/menubar/'.$module->module_id.'.png';?>" onmouseover="this.width=60;this.height=60;" onmouseout="this.width=40;this.height=40;" width="40" height="40" alt=""  /></a><br />
