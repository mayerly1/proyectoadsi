...
<div id="edit_sale_wrapper">
	<h1><?php echo $this->lang->line('sales_edit_sale'); ?> N° <?php echo $sale_info['sale_id']; ?></h1>
	...
	<?php echo form_label($this->lang->line('sales_receipt').':', 'customer'); ?>
		...
		<div class='form_field'>
			<?php echo anchor('sales/receipt/'.$sale_info['sale_id'], ' FRA. '.$sale_info['sale_id'], array('target' => '_blank'));?>
		</div>
	</div>
	...
	<?php echo form_label($this->lang->line('sales_date').':', 'date'); ?>
		<div class='form_field'>
			<?php echo form_input(array('name'=>'date','value'=>date('m/d/Y H:i:s', strtotime($sale_info['sale_time'])), 'id'=>'date'));?>
		</div>
	</div>
