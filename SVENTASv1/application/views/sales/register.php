...
<th style="width:11%;"><?php echo $this->lang->line(''); ?></th>
...
else
{
	...
	?>
		<tr>
		<td><?php echo anchor("sales/delete_item/$line",'['.$this->lang->line('common_delete1').']');?></td>
		<td><?php echo $item['item_number']; ?></td>
		<td style="align:center;"><?php echo $item['name']; ?><br /> [<?php echo $cur_item_info->quantity; ?> en stock]</td>
...
<div id="overall_sale">
	...
	<?php
	// Mostrar esta parte si hay productos que ya están en la venta .
	...
	?>
		...
		<?php
		// Mostrar esta parte solo si hay al menos un pago introducido.
		if(count($payments) > 0)
		{
		?>
			<div id="finish_sale">
