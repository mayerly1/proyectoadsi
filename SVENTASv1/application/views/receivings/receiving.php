...
else
{
	...
	?>
		<tr>
		<td><?php echo anchor("receivings/delete_item/$line",'['.$this->lang->line('common_delete1').']');?></td>
...
<div id="overall_sale">
	...
	if(isset($supplier))
	{
		...
		echo anchor("receivings/delete_supplier",'['.$this->lang->line('common_delete1').' '.$this->lang->line('suppliers_supplier').']');
	}
	else
	{
