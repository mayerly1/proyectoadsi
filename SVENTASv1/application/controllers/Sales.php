...
class Sales extends Secure_area
{
	...
	function edit_item($line)
	{
		...
		{
			$this->sale_lib->edit_item($line,$description,$quantity,$discount,$price);
		}
		else
		{
	...
	function complete()
	{
		...
		//Guardar precio de base de datos
		$data['sale_id']='FRA. '.$this->Sale->save($data['cart'], $customer_id,$employee_id,$comment,$data['payments']);
		if ($data['sale_id'] == 'FRA. -1')
		{
	...
	function _payments_cover_total()
	{
		...
		/* Cambia el condicional para redondeo de punto flotante */
